...
const confirmShowModal = () => {
    confirmingShowModal.value = true;
};
...
<template>
    ...
    <PrimaryButton text-size="lg" class="w-10/12" @click="confirmShowModal">
        Post
    </PrimaryButton>

    <!-- Modal for creating new thread -->
    <Modal :show="confirmingShowModal" @close="closeModal">
        <!-- Modal content with max height and flex column layout -->
        <div class="flex flex-col h-full min-h-[25vh] max-h-[65vh] sm:w-full">
            ...
            <div class="overflow-auto px-3 py-3">
                <div class="flex gap-x-3">
                    ...
                    <!-- User avatar -->
                    <img class="h-12 w-12 lg:block dark:bg-gray-50 rounded-full bg-gray-800 hidden" :src="`/storage/${$page.props.auth.user.avatar}`"
                        alt="" />
