<script setup>
    ...
    <template>
  <div class="relative  dark:bg-gray-900 w-full mt-2  right-1.5 border rounded dark:border-gray-700 mx-auto">
    <div class="relative h-80 overflow-hidden bg-indigo-600 md:absolute md:left-0 md:h-full md:w-1/3 lg:w-1/2">
      <img class="h-full w-full object-cover rounded" src="https://miro.medium.com/v2/resize:fit:1024/1*DPfJxl6kzv3BHa-dvhkZSA@2x.jpeg" alt="" />
    ...
    <div class="relative mx-auto max-w-7xl py-24 sm:py-32 lg:px-8 lg:py-40">
      <div class="pl-6 pr-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32">
        <h2 class="text-base font-semibold leading-7 text-indigo-400">It's your time to create something wonderul.</h2>
        <p class="mt-2 text-3xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-4xl">It's just a click of a button.</p>
        <div class="mt-8">
          <a href="#" class="inline-flex rounded-md bg-theme-purple px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-white/20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Get started</a>
        </div>
      </div>
    </div>
  </div>
